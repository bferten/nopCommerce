...
public partial class ArtificialIntelligenceDefaults
{
    ...
    /// Gets a query format string for generate product description with AI
    /// </summary>
    public static string MetaKeywordsQuery => "Create three or four of keywords on the {2} language for the page with \"{0}\" title and \"{1}\" text. Optimize the result for SEO, list them separated by commas.Use plain text for response";
