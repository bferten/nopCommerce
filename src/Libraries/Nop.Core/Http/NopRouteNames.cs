...
public static partial class NopRouteNames
{
    public static class Generic
    {
        ...
        /// <summary>
        /// Gets the giftcard balance route name
        /// </summary>
    ...
    public static class Standard
    {
        ...
        /// <summary>
        /// Gets the passwordrecovery route name
        /// </summary>
        ...
        /// <summary>
        /// Gets the get order note file route name
        /// </summary>
        ...
        /// <summary>
        /// Gets the new RSS (file result) route name
        /// </summary>
    ...
    public static class Ajax
    {
        ...
        /// <summary>
        /// Gets the catalog products route name
        /// </summary>
