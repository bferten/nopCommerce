...
public partial class MetaTagsGeneratorViewComponent : NopViewComponent
{
    ...
    public IViewComponentResult Invoke(MetaTagsGeneratorModel model)
    {
        ...
        if (!_artificialIntelligenceSettings.AllowGenerateMetaTitle &&
            !_artificialIntelligenceSettings.AllowGenerateMetaKeywords &&
            !_artificialIntelligenceSettings.AllowGenerateMetaDescription)
            return Content(string.Empty);
