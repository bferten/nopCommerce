...
public partial class SitemapModelFactory : ISitemapModelFactory
{
    ...
    protected virtual async Task<IList<SitemapUrlModel>> GenerateUrlsAsync()
    {
        ...
        {
            //home page
            await PrepareLocalizedSitemapUrlAsync(NopRouteNames.Generic.HOMEPAGE),

            //search products
            await PrepareLocalizedSitemapUrlAsync(NopRouteNames.Generic.SEARCH),

            //contact us
            await PrepareLocalizedSitemapUrlAsync(NopRouteNames.Generic.CONTACT_US)
        };

        //news
        if (_newsSettings.Enabled)
            sitemapUrls.Add(await PrepareLocalizedSitemapUrlAsync(NopRouteNames.Generic.NEWS));

        //blog
        if (_blogSettings.Enabled)
            sitemapUrls.Add(await PrepareLocalizedSitemapUrlAsync(NopRouteNames.Generic.BLOG));

        //forum
        if (_forumSettings.ForumsEnabled)
            sitemapUrls.Add(await PrepareLocalizedSitemapUrlAsync(NopRouteNames.Generic.BOARDS));
    ...
    public virtual async Task<SitemapModel> PrepareSitemapModelAsync(SitemapPageModel pageModel)
    {
        ...
        var cachedModel = await _staticCacheManager.GetAsync(cacheKey, async () =>
        {
            ...
            model.Items.Add(new SitemapModel.SitemapItemModel
            {
                ...
                Url = urlHelper.RouteUrl(NopRouteNames.Generic.HOMEPAGE)
            });
            ...
            model.Items.Add(new SitemapModel.SitemapItemModel
            {
                ...
                Url = urlHelper.RouteUrl(NopRouteNames.Generic.SEARCH)
            });
            ...
            if (_newsSettings.Enabled)
            {
                model.Items.Add(new SitemapModel.SitemapItemModel
                {
                    ...
                    Url = urlHelper.RouteUrl(NopRouteNames.Generic.NEWS)
                });
            }
            ...
            if (_blogSettings.Enabled)
            {
                model.Items.Add(new SitemapModel.SitemapItemModel
                {
                    ...
                    Url = urlHelper.RouteUrl(NopRouteNames.Generic.BLOG)
                });
            }
            ...
            if (_forumSettings.ForumsEnabled)
            {
                model.Items.Add(new SitemapModel.SitemapItemModel
                {
                    ...
                    Url = urlHelper.RouteUrl(NopRouteNames.Generic.BOARDS)
                });
            }
            ...
            model.Items.Add(new SitemapModel.SitemapItemModel
            {
                ...
                Url = urlHelper.RouteUrl(NopRouteNames.Generic.CONTACT_US)
            });
            ...
            model.Items.Add(new SitemapModel.SitemapItemModel
            {
                ...
                Url = urlHelper.RouteUrl(NopRouteNames.Generic.CUSTOMER_INFO)
            });
