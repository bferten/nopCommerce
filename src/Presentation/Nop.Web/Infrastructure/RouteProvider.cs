...
public partial class RouteProvider : BaseRouteProvider, IRouteProvider
{
    ...
    public void RegisterRoutes(IEndpointRouteBuilder endpointRouteBuilder)
    {
        ...
        //home page
        endpointRouteBuilder.MapControllerRoute(name: NopRouteNames.Generic.HOMEPAGE,
            pattern: $"{lang}",
            defaults: new { controller = "Home", action = "Index" });

        //login
        endpointRouteBuilder.MapControllerRoute(name: NopRouteNames.Generic.LOGIN,
            pattern: $"{lang}/login/",
        ...
        //shopping cart
        endpointRouteBuilder.MapControllerRoute(name: NopRouteNames.Generic.CART,
            pattern: $"{lang}/cart/",
        ...
        //wishlist
        endpointRouteBuilder.MapControllerRoute(name: NopRouteNames.Generic.WISHLIST,
        ...
        endpointRouteBuilder.MapControllerRoute(name: NopRouteNames.Generic.CUSTOMER_INFO,
            pattern: $"{lang}/customer/info",
            defaults: new { controller = "Customer", action = "Info" });

        endpointRouteBuilder.MapControllerRoute(name: NopRouteNames.Generic.CUSTOMER_ADDRESSES,
        ...
        endpointRouteBuilder.MapControllerRoute(name: NopRouteNames.Generic.CUSTOMER_ORDERS,
        ...
        //contact us
        endpointRouteBuilder.MapControllerRoute(name: NopRouteNames.Generic.CONTACT_US,
            pattern: $"{lang}/contactus",
            defaults: new { controller = "Common", action = "ContactUs" });

        //product search
        endpointRouteBuilder.MapControllerRoute(name: NopRouteNames.Generic.SEARCH,
            pattern: $"{lang}/search/",
        ...
        endpointRouteBuilder.MapControllerRoute(name: NopRouteNames.Generic.RECENTLY_VIEWED_PRODUCTS,
            pattern: $"{lang}/recentlyviewedproducts/",
            defaults: new { controller = "Product", action = "RecentlyViewedProducts" });

        //new products
        endpointRouteBuilder.MapControllerRoute(name: NopRouteNames.Generic.NEW_PRODUCTS,
            pattern: $"{lang}/newproducts/",
            defaults: new { controller = "Catalog", action = "NewProducts" });

        //blog
        endpointRouteBuilder.MapControllerRoute(name: NopRouteNames.Generic.BLOG,
            pattern: $"{lang}/blog",
            defaults: new { controller = "Blog", action = "List" });

        //news
        endpointRouteBuilder.MapControllerRoute(name: NopRouteNames.Generic.NEWS,
            pattern: $"{lang}/news",
            defaults: new { controller = "News", action = "List" });

        //forum
        endpointRouteBuilder.MapControllerRoute(name: NopRouteNames.Generic.BOARDS,
            pattern: $"{lang}/boards",
            defaults: new { controller = "Boards", action = "Index" });

        //compare products
        endpointRouteBuilder.MapControllerRoute(name: NopRouteNames.Generic.COMPARE_PRODUCTS,
            pattern: $"{lang}/compareproducts/",
            defaults: new { controller = "Product", action = "CompareProducts" });

        //product tags
        endpointRouteBuilder.MapControllerRoute(name: NopRouteNames.Generic.PRODUCT_TAGS,
            pattern: $"{lang}/producttag/all/",
            defaults: new { controller = "Catalog", action = "ProductTagsAll" });

        //manufacturers
        endpointRouteBuilder.MapControllerRoute(name: NopRouteNames.Generic.MANUFACTURERS,
            pattern: $"{lang}/manufacturer/all/",
            defaults: new { controller = "Catalog", action = "ManufacturerAll" });

        //vendors
        endpointRouteBuilder.MapControllerRoute(name: NopRouteNames.Generic.VENDORS,
        ...
        endpointRouteBuilder.MapControllerRoute(name: NopRouteNames.Generic.APPLY_VENDOR_ACCOUNT,
        ...
        endpointRouteBuilder.MapControllerRoute(name: NopRouteNames.Generic.CHECK_GIFT_CARD_BALANCE,
        ...
        //sitemap
        endpointRouteBuilder.MapControllerRoute(name: NopRouteNames.Generic.SITEMAP,
